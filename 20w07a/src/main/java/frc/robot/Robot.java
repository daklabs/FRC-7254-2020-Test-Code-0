...
public class Robot extends TimedRobot {
  ...
  // Analog input for depth sensor, uses the port number it's plugged into.
  AnalogInput ultrasonic = new AnalogInput(0);
  // Variable to save the current distance to.
  ...
  public void robotPeriodic() {
    // Get and scale distance 
    currentDistance = ultrasonic.getValue() * 0.125;
